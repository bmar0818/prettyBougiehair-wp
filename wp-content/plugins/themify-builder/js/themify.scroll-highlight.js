    ...
    Plugin.prototype = (function () {
        ...
        return {
            ...
            changeHash: function (href) {
                if (_opt.activeSection && ('#' === href || href === cleanHash(window.location.hash)))
                    return;
            ...
            manualScroll: function (elementsToCheck) {
                ...
                if (_opt.$window.scrollTop() < self.options.fixedHeaderHeight) {
                    ...
                    if (_opt.activeSection) {
                        if (!self.isInViewport(_opt.activeSection)) {
                            self.removeHash();
            ...
            init: function () {
                ...
                if (!Themify.is_builder_active) {
                    ...
                    _opt.$window.on('load hashchange', function (e) {
                        if (isWorking === false) {
                            isWorking = true;
