...
d&&(g.url=a.addQueryArg("themify_builder_infinite_scroll","yes",g.url))})},InitScrollHighlight:function(){1!=tbLocalScript.loadScrollHighlight||!f.is_builder_active&&null===k.querySelector("div[class*=tb_section-]")||f.LoadAsync(tbLocalScript.builder_url+"/js/themify.scroll-highlight.js",function(){f.body.themifyScrollHighlight(tbScrollHighlight?tbScrollHighlight:{})},null,null,function(){return"undefined"!==typeof b.fn.themifyScrollHighlight})},backgroundSlider:function(a){function c(){var a=tbLocalScript.backgroundSlider.autoplay,
